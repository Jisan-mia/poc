 ...
 * limitations under the License.
 */
const R=1e3,N=2,A=144e5,D=.5;function L(e,t=R,n=N){const i=t*Math.pow(n,e),r=Math.round(D*i*(Math.random()-.5)*2);return Math.min(A,i+r)}
/**
 * @license
 ...
 * limitations under the License.
 */
function be(e){ue(new m("platform-logger",e=>new j(e),"PRIVATE")),ve(C,R,e),ve(C,R,"esm2017"),ve("fire-js","")}be("");var ye="firebase",we="9.6.3";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
ve(ye,we,"app");var Ie=n("9dbb");const _e="@firebase/installations",Oe="0.5.5",ke=1e4,Te="w:"+Oe,Se="FIS_v2",Ee="https://firebaseinstallations.googleapis.com/v1",je=36e5,Pe="installations",Ce="Installations",Re={["missing-app-config-values"]:'Missing App configuration value: "{$valueName}"',["not-registered"]:"Firebase Installation is not registered.",["installation-not-found"]:"Firebase Installation not found.",["request-failed"]:'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',["app-offline"]:"Could not process request. Application offline.",["delete-pending-registration"]:"Can't delete installation while there is a pending registration request."},Ne=new f["b"](Pe,Ce,Re);function Ae(e){return e instanceof f["c"]&&e.code.includes("request-failed")}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ct(e){const t=e,{installationEntry:n,registrationPromise:i}=await dt(t.appConfig);return i?i.catch(console.error):It(t).catch(console.error),n.fid}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rt(e,t=!1){const n=e;await Nt(n.appConfig);const i=await It(n,t);return i.token}async function Nt(e){const{registrationPromise:t}=await dt(e);t&&await t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lt="installations",Mt="installations-internal",xt=e=>{const t=e.getProvider("app").getImmediate(),n=At(t),i=le(t,"platform-logger"),r={app:t,appConfig:n,platformLoggerProvider:i,_delete:()=>Promise.resolve()};return r},Ut=e=>{const t=e.getProvider("app").getImmediate(),n=le(t,Lt).getImmediate(),i={getId:()=>Ct(n),getToken:e=>Rt(n,e)};return i};function Vt(){ue(new m(Lt,xt,"PUBLIC")),ue(new m(Mt,Ut,"PRIVATE"))}Vt(),ve(_e,Oe),ve(_e,Oe,"esm2017");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jn(e,t,n,i,r){if(r&&r.global)e("event",n,i);else{const r=await t,s=Object.assign(Object.assign({},i),{send_to:r});e("event",n,s)}}function Pn(e=ge()){e=Object(f["j"])(e);const t=le(e,Ft);return t.isInitialized()?t.getImmediate():Cn(e)}function Cn(e,t={}){const n=le(e,Ft);if(n.isInitialized()){const e=n.getImmediate();if(Object(f["h"])(t,n.getOptions()))return e;throw nn.create("already-initialized")}const i=n.initialize({options:t});return i}function Rn(e,t,n,i){e=Object(f["j"])(e),jn(_n,bn[e.app.options.appId],t,n,i).catch(e=>Wt.error(e))}const Nn="@firebase/analytics",An="0.7.5";function Dn(){function e(e){try{const t=e.getProvider(Ft).getImmediate();return{logEvent:(e,n,i)=>Rn(t,e,n,i)}}catch(t){throw nn.create("interop-component-reg-failed",{reason:t})}}ue(new m(Ft,(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return En(n,i,t)},"PUBLIC")),ue(new m("analytics-internal",e,"PRIVATE")),ve(Nn,An),ve(Nn,An,"esm2017")}Dn();function Ln(e,t){var n={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(null!=e&&"function"===typeof Object.getOwnPropertySymbols){var r=0;for(i=Object.getOwnPropertySymbols(e);r<i.length;r++)t.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(e,i[r])&&(n[i[r]]=e[i[r]])}return n}Object.create;Object.create;function Mn(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const xn=Mn,Un=new f["b"]("auth","Firebase",Mn()),Vn=new E("@firebase/auth");function Fn(e,...t){Vn.logLevel<=_.ERROR&&Vn.error(`Auth (${fe}): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ci(e,t){const n=await li(e,{},async()=>{const n=Object(f["r"])({grant_type:"refresh_token",refresh_token:t}).slice(1),{tokenApiHost:i,apiKey:r}=e.config,s=hi(e,i,"/v1/token","key="+r),o=await e._getAdditionalHeaders();return o["Content-Type"]="application/x-www-form-urlencoded",si.fetch()(s,{method:"POST",headers:o,body:n})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ri{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){qn(e.idToken,"internal-error"),qn("undefined"!==typeof e.idToken,"internal-error"),qn("undefined"!==typeof e.refreshToken,"internal-error");const t="expiresIn"in e&&"undefined"!==typeof e.expiresIn?Number(e.expiresIn):Ii(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return qn(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:r}=await Ci(e,t);this.updateTokensAndExpiration(n,i,Number(r))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+1e3*n}static fromJSON(e,t){const{refreshToken:n,accessToken:i,expirationTime:r}=t,s=new Ri;return n&&(qn("string"===typeof n,"internal-error",{appName:e}),s.refreshToken=n),i&&(qn("string"===typeof i,"internal-error",{appName:e}),s.accessToken=i),r&&(qn("number"===typeof r,"internal-error",{appName:e}),s.expirationTime=r),s}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Ri,this.toJSON())}_performRefresh(){return Wn("not implemented")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cr(e,t,n=!1){const i=await _i(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Sr._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const js=Is("rcb"),Ps=new ii(3e4,6e4),Cs="https://www.google.com/recaptcha/api.js?";class Rs{constructor(){this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!Jr().grecaptcha}load(e,t=""){return qn(Ns(t),e,"argument-error"),this.shouldResolveImmediately(t)?Promise.resolve(Jr().grecaptcha):new Promise((n,i)=>{const r=Jr().setTimeout(()=>{i($n(e,"network-request-failed"))},Ps.get());Jr()[js]=()=>{Jr().clearTimeout(r),delete Jr()[js];const s=Jr().grecaptcha;if(!s)return void i($n(e,"internal-error"));const o=s.render;s.render=(e,t)=>{const n=o(e,t);return this.counter++,n},this.hostLanguage=t,n(s)};const s=`${Cs}?${Object(f["r"])({onload:js,render:"explicit",hl:t})}`;ws(s).catch(()=>{clearTimeout(r),i($n(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){return!!Jr().grecaptcha&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function Ns(e){return e.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(e)}class As{async load(e){return new Ts(e)}clearedOneInstance(){}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const So={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Eo=500,jo=600,Po="_blank",Co="http://localhost";class Ro{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch(e){}}}function No(e,t,n,i=Eo,r=jo){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c=Object.assign(Object.assign({},So),{width:i.toString(),height:r.toString(),top:s,left:o}),u=Object(f["k"])().toLowerCase();n&&(a=zi(u)?Po:n),Vi(u)&&(t=t||Co,c.scrollbars="yes");const l=Object.entries(c).reduce((e,[t,n])=>`${e}${t}=${n},`,"");if(Ki(u)&&"_self"!==a)return Ao(t||"",a),new Ro(null);const d=window.open(t||"",a,l);qn(d,e,"popup-blocked");try{d.focus()}catch(h){}return new Ro(d)}function Ao(e,t){const n=document.createElement("a");n.href=e,n.target=t;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *

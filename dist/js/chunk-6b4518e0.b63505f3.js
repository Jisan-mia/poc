 ...
 * limitations under the License.
 */
ve(ye,Ie,"app");var we=n("9dbb");const _e="@firebase/installations",Oe="0.5.5",ke=1e4,Te="w:"+Oe,Ee="FIS_v2",Se="https://firebaseinstallations.googleapis.com/v1",Re=36e5,Ce="installations",je="Installations",Pe={["missing-app-config-values"]:'Missing App configuration value: "{$valueName}"',["not-registered"]:"Firebase Installation is not registered.",["installation-not-found"]:"Firebase Installation not found.",["request-failed"]:'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',["app-offline"]:"Could not process request. Application offline.",["delete-pending-registration"]:"Can't delete installation while there is a pending registration request."},Ne=new f["b"](Ce,je,Pe);function Ae(e){return e instanceof f["c"]&&e.code.includes("request-failed")}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ft="analytics",zt="firebase_id",$t="origin",Bt=6e4,Ht="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",qt="https://www.googletagmanager.com/gtag/js",Wt=new S("@firebase/analytics");
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rn(e,t,n,i,r){if(r&&r.global)e("event",n,i);else{const r=await t,s=Object.assign(Object.assign({},i),{send_to:r});e("event",n,s)}}function Cn(e=ge()){e=Object(f["j"])(e);const t=le(e,Ft);return t.isInitialized()?t.getImmediate():jn(e)}function jn(e,t={}){const n=le(e,Ft);if(n.isInitialized()){const e=n.getImmediate();if(Object(f["h"])(t,n.getOptions()))return e;throw nn.create("already-initialized")}const i=n.initialize({options:t});return i}function Pn(e,t,n,i){e=Object(f["j"])(e),Rn(_n,bn[e.app.options.appId],t,n,i).catch(e=>Wt.error(e))}const Nn="@firebase/analytics",An="0.7.5";function Dn(){function e(e){try{const t=e.getProvider(Ft).getImmediate();return{logEvent:(e,n,i)=>Pn(t,e,n,i)}}catch(t){throw nn.create("interop-component-reg-failed",{reason:t})}}ue(new m(Ft,(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return Sn(n,i,t)},"PUBLIC")),ue(new m("analytics-internal",e,"PRIVATE")),ve(Nn,An),ve(Nn,An,"esm2017")}Dn();function Ln(e,t){var n={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(null!=e&&"function"===typeof Object.getOwnPropertySymbols){var r=0;for(i=Object.getOwnPropertySymbols(e);r<i.length;r++)t.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(e,i[r])&&(n[i[r]]=e[i[r]])}return n}Object.create;Object.create;function Mn(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const xn=Mn,Un=new f["b"]("auth","Firebase",Mn()),Vn=new S("@firebase/auth");function Fn(e,...t){Vn.logLevel<=_.ERROR&&Vn.error(`Auth (${fe}): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jr(e,t,n=!1){const i=await _i(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Er._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nr(e,t,n=!1){const i="signIn",r=await Cr(e,i,t),s=await Er._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}async function Ar(e,t){return Nr(Qi(e),t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
